...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `ecommerce-backend`;

CREATE SCHEMA `ecommerce-backend`;
USE `ecommerce-backend` ;

-- -----------------------------------------------------
-- Table `full-stack-ecommerce`.`product_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce-backend`.`product_category` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ecommerce-backend`.`product` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
VALUES (1,'BOOK-TECH-1000', 'JavaScript - The Fun Parts', 'Learn JavaScript',
